...
import io.sufe.gateway.thread.GatewayThreadFactory;
...
public enum DefaultChannelPool {
    ...
    private NioEventLoopGroup nioEventLoopGroup = new NioEventLoopGroup(Runtime.getRuntime().availableProcessors() << 1, GatewayThreadFactory.create(CLIENT_EVENT_LOOP_NAME, true));
