...
public enum DefaultChannelPool {
    ...
    private NioEventLoopGroup nioEventLoopGroup = new NioEventLoopGroup(Runtime.getRuntime().availableProcessors() << 1, GatewayThreadFactory.create(Constants.CLIENT_EVENT_LOOP_NAME, true));
    ...
    public void offer(Channel channel, String host) {
        ...
        if (channels.size() < 100) { //成功将连接放回池中
...
//        return channelFuture;
    ...
    private static class Initializer extends ChannelInitializer<Channel> {
        ...
        protected void initChannel(Channel ch) {
            ...
            ch.pipeline().addLast(new HttpObjectAggregator(Constants.CLIENT_MAX_CONTENT_LENGTH));
